...
template <> constexpr inline auto Command::qt_create_metaobjectdata<qt_meta_tag_ZN7CommandE_t>()
{
    ...
    QtMocHelpers::UintData qt_methods {
        // Method 'excel'
        QtMocHelpers::MethodData<QStringList(QString, QStringList)>(1, 2, QMC::AccessPublic, QMetaType::QStringList, {{
...
void Command::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: { QStringList _r = _t->excel((*reinterpret_cast< std::add_pointer_t<QString>>(_a[1])),(*reinterpret_cast< std::add_pointer_t<QStringList>>(_a[2])));
